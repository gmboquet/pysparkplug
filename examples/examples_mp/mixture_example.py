...
if __name__ == '__main__':
    ...
    #
    # Here the training data is sharded across worker processes once; each EM
    # iteration ships only the (small) model out and sufficient statistics back.

    with MPEncodedData(train_data, estimator=est, num_workers=4) as enc_train:
